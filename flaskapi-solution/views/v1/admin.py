...
from keycloak import KeycloakPostError, KeycloakDeleteError, KeycloakPutError
...
from models.models import BoolResponse, Role, RoleList, RoleIds, UserRole, RoleCheck, ErrorStr
...
@api.validate(body=Request(RoleCheck), resp=Response(HTTP_200=BoolResponse, HTTP_403=None,
...
@check_session
@rate_limiter(settings.rate_limit, settings.time_period)
@api.validate(resp=Response(HTTP_200=BoolResponse, HTTP_403=None,
                            HTTP_429=ErrorStr), tags=['admin'])
